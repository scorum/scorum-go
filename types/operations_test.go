...
func Test_CreateNFTOperation_Marshall(t *testing.T) {
	...
	require.EqualValues(t,
		"2b086f70657261746f72aa3b2bdc176e5e8a9b487dba3aa1004406726f636b6574027b7d6400000000000000",
		hex.EncodeToString(b.Bytes()),
	)
}
...
func Test_GameRoundResultOperation_Marshall(t *testing.T) {
	op := GameRoundResultOperation{
		Owner:  "operator",
		UUID:   uuid.MustParse("aa3b2bdc-176e-5e8a-9b48-7dba3aa10044"),
	...
	require.Equal(t,
		"",
		hex.EncodeToString(b.Bytes()),
	)
}
